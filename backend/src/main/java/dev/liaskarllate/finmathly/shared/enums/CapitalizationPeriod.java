...
public enum CapitalizationPeriod {
    ...
    DAILY_360(BigDecimal.ONE.divide(new BigDecimal("30"), MathContext.DECIMAL64), "daily (360-day year)"),
    DAILY_252(BigDecimal.ONE.divide(new BigDecimal("21"), MathContext.DECIMAL64), "daily (252-day year)");
